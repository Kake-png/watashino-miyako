const ATLAS_DATA = (() => {
  const sources = {
    ...
    "togoshiginza-station": {
      ...
      license: "CC BY-SA 4.0",
      licenseUrl: "https://creativecommons.org/licenses/by-sa/4.0/",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:Togoshi-Ginza_Station(GotandaGates).jpg",
      changes: "縮小・WebP変換・表示時にトリミング"
    },
    "nakanobu-skiproad": {
      file: "images/nakanobu-skiproad.webp",
      alt: "中延の商店街スキップロード",
      caption: "二つの鉄道路線の間に日常の商店街が続く。古い写真のため、街路の骨格を見る資料として扱う。",
      date: "2009年1月",
      author: "Kentin",
      license: "CC BY-SA 3.0",
      licenseUrl: "https://creativecommons.org/licenses/by-sa/3.0/",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:Nakanobu_skip_road_shinagawa.JPG",
      changes: "縮小・WebP変換・表示時にトリミング"
    },
    "hatanodai-platform": {
    ...
    "ookayama-station": {
      ...
      alt: "大岡山駅前",
      caption: "病院と大学が駅前にあり、その外側に住宅地が広がる。撮影時期が古いため建物の現況は確認が必要。",
      date: "2012年2月",
      author: "豊田出庫線",
      license: "CC BY-SA 3.0",
      licenseUrl: "https://creativecommons.org/licenses/by-sa/3.0/",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:Ookayama_eki.png",
      changes: "縮小・WebP変換・表示時にトリミング"
    },
    "jiyugaoka-station": {
    ...
    "musashikosugi-station": {
      ...
      alt: "武蔵小杉駅と高層住宅",
      caption: "複数の駅施設と高層住宅が広い範囲に分かれる。路線間の徒歩距離まで含めて駅を考えたい。",
      date: "2020年11月",
      author: "Drivephotographer",
      license: "CC0",
      licenseUrl: "https://creativecommons.org/publicdomain/zero/1.0/",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:Musashi-kosugi_station.jpg",
      changes: "縮小・WebP変換・表示時にトリミング"
    },
    "yokohama-east": {
      ...
      license: "CC BY 4.0",
      licenseUrl: "https://creativecommons.org/licenses/by/4.0/",
      sourceUrl: "https://commons.wikimedia.org/wiki/File:Yokohama_Station_East_exit_Taxi_plaza.jpg",
      changes: "縮小・WebP変換・表示時にトリミング"
    },
    "oimachi-station": {
  ...
  const practicalNotes = {
    oimachi: { cost: "この15駅では高め。駅近・複数路線の利便性が反映されやすい。", car: "幹線道路・首都高湾岸線方面へ出やすいが、駐車場費と細街路を要確認。", outdoors: "しながわ中央公園方面や湾岸方向へ自転車で動ける。", evening: "駅前は夜も用事を済ませやすい。飲食街と住宅側の距離を確認。" },
    ...
    osaki: { cost: "駅近の新しい住宅は高め。駅から離れた坂側まで範囲を広げて比較したい。", car: "幹線道路へ接続できるが、デッキ街区と一方通行で動線が複雑。", outdoors: "目黒川沿いを歩ける。大きな公園は方向を選んで移動する。", evening: "平日夜と休日で人通り・営業店舗が変わりやすい。" },
    gotanda: { cost: "都心アクセスを反映して高め。坂上・駅東西・築年数で条件が分かれる。", car: "国道1号・首都高目黒線方面へ出られるが、駅前交通量と駐車場費は重い。", outdoors: "目黒川沿いの散歩ができる。坂を含む徒歩圏との差が特徴。", evening: "飲食店が多く夜も動く。繁華街を通るか避けるかで帰宅路が変わる。" },
    musashikoyama: { cost: "人気と再開発の影響で高め。商店街から外れた距離も含めて比較。", car: "住宅街の細道が多く、車中心より徒歩・自転車向き。首都高利用は経路確認が必要。", outdoors: "林試の森公園が強い。日常散歩の目的地を作りやすい。", evening: "商店街は明るいが、一本外れた住宅路との落差を確認。" },
    ...
    ookayama: { cost: "落ち着いた住宅地と二路線の利便性で高めになりやすい。", car: "環七方面へ出られるが、駅周辺は徒歩中心。坂と細道を確認。", outdoors: "洗足池・緑が丘方面へ散歩や自転車を組み込みやすい。", evening: "学生の動きはあるが大規模な夜の繁華街ではない。" },
    jiyugaoka: { cost: "この15駅では高め。駅距離を伸ばしても人気住宅地の影響が残りやすい。", car: "細い道と人通りが多く、駅前へ車で入る生活は慎重に確認。", outdoors: "緑道や住宅街散歩と相性がよい。多摩川方面へも自転車で展開可能。", evening: "飲食は選びやすいが、夜遅くまでの生活利便は通りごとの差がある。" },
    ...
    musashikosugi: { cost: "交通利便性と駅前住宅の人気で高め。新丸子側など周辺駅も含めて比較。", car: "主要道路へ出られるが、駅前街区とタワー駐車場の条件を個別確認。", outdoors: "多摩川河川敷が強い。散歩、ランニング、サイクリングと相性がよい。", evening: "駅前は明るいが、利用路線から自宅までの実際の距離を夜に歩きたい。" },
    yokohama: { cost: "駅徒歩圏は高め。出口・川・幹線道路を越えるかで条件幅が大きい。", car: "横浜駅西口出入口など高速アクセスは強いが、渋滞と駐車場費が課題。", outdoors: "港・みなとみらい方面の散歩や夜景へ出やすい。駅直近は人通りが多い。", evening: "飲食・娯楽は豊富。繁華街を通る帰宅路と静かな住宅側を分けて見る。" }
  };
