...
if (!indexHtml.includes('type="module" src="/assets/app.js?v=24"')) errors.push("Home is missing versioned module app script");
...
if (!appSource.includes('from "/assets/data.js?v=24"')) errors.push("App is missing the versioned data module import");
